...
export default function PartnerSupportPage() {
  ...
  async function fetchTickets() {
    try {
      setLoading(true);
      const response = await partnerApi.getSupportTickets({
    ...
    <div className="p-6 space-y-6">
        ...
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              Order delays, agent assignment issues, payment problems, and more
            </p>
          </CardContent>
        </Card>
        <Card>
          <CardContent className="p-6 text-center">
            ...
            <p className="text-sm text-gray-600">
              Learn how to integrate our API and manage orders programmatically
            </p>
          </CardContent>
        </Card>
        <Card>
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <div className="flex items-center gap-2 mb-2">
                          ...
                          {ticket.order && (
                            <button
                              onClick={() => router.push(`/partner/orders/${ticket.order?.id}`)}
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">How do I create an order?</h3>
            <p className="text-sm text-gray-600">
              Navigate to the "Create Order" page, select pickup and dropoff locations, set the payout amount, and submit. An agent will be assigned automatically.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">What should I do if an order is delayed?</h3>
            <p className="text-sm text-gray-600">
              Create a support ticket with the issue type "Delivery Delay" and provide details. Our team will investigate and work with the assigned agent to resolve the issue.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">How do I track my orders?</h3>
            <p className="text-sm text-gray-600">
              Use the "Tracking" page to view all your orders and their real-time status. You can also view detailed information on each order's detail page.
            </p>
          </div>
          <div>
            <h3 className="font-semibold text-gray-900 mb-1">How do I integrate the API?</h3>
            <p className="text-sm text-gray-600">
              Check your API key in the Settings page and refer to the API documentation. Use webhooks to receive real-time order updates.
            </p>
          </div>
        </CardContent>
      </Card>
